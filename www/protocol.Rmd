...
This protocol is for Oxford Nanopore sequencing of plasmid or bacterial genome samples using rapid barcoding kits (SQK-RBK114.96).  
...
| |gDNA| plasmid |
|:---|---:|---:|
| DNA + water | 10.0 ul | 5.0 ul |
| rapid barcode | 1.0 ul | 0.5 ul|
| **total** | **11.0 ul** | **5.5 ul** |
...
|    | Flongle | MinION |
|:---|---:|---:|
| Sequencing buffer (SB) | 15 ul | 37.5 ul |
| Library beads (LIB) | 10 ul | 25.5 ul|
